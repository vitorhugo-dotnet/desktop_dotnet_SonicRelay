...
This repository contains the .NET 10 and WinUI 3 publisher, device-identity HTTP clients, secure QR pairing, WASAPI loopback capture, WebRTC/Opus publishing, and DeviceBearer WebSocket signaling.
